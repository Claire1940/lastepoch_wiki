...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Last Epoch Wiki',
    description: 'Copyright and intellectual property information for Last Epoch Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Last Epoch Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Last Epoch Wiki',
      description: 'Copyright and intellectual property information for Last Epoch Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Last Epoch Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Last Epoch Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Last Epoch Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Eleventh Hour Games</strong> - Developer of Last Epoch</li>
              <li><strong>Steam / Valve Corporation</strong> - Distribution platform</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>LAST EPOCH</strong> - Trademark of Eleventh Hour Games</li>
              <li><strong>Steam</strong> - Trademark of Valve Corporation</li>
              <li><strong>Last Epoch Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Last Epoch Wiki.
            </p>
            ...
            <p>
              ...
              Last Epoch Wiki<br />
              Email: <a href="mailto:dmca@lastepoch.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@lastepoch.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Last Epoch Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Last Epoch Wiki (lastepoch.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@lastepoch.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@lastepoch.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@lastepoch.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@lastepoch.wiki</a>
            </p>
            <p>
