...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Last Epoch Wiki',
    description: 'Last Epoch Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our PC game resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Last Epoch Wiki privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Last Epoch Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Last Epoch Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Eleventh Hour Games or the publishers of Last Epoch. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@lastepoch.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@lastepoch.wiki</a>
            </p>
            <p>
