...
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.lastepoch.wiki'
...
const contentTypePriority: Record<string, number> = {
	'guide': 0.9,
	'builds': 0.9,
	'classes-and-tier-list': 0.8,
	'season-4-and-updates': 0.8,
}
...
const contentTypeChangeFrequency: Record<string, 'daily' | 'weekly' | 'monthly'> = {
	'guide': 'weekly',
	'builds': 'weekly',
	'classes-and-tier-list': 'weekly',
	'season-4-and-updates': 'weekly',
}
